...
backButtons.forEach(button => button.addEventListener("click", e => closeSubMenu(e.target))); //Adding event listener to hide mobile menu if window is resized to normal size
